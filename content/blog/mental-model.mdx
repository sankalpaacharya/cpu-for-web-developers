...
this explain later not rn 

but maybe that also begs a question, we know some library like `react-three-fiber` they don't always render the UI in tree format 
it's a html canvas and webgl

if you are not familar with html canvas or webgl no it's, canvas is just like a blank paper 
